export default class HandGestureService {
    ...
    #detector = null;
    #gestureStrings;
    constructor({ fingerpose, handPoseDetection, handsVersion, gestureStrings, knowGestures }) {
    ...
    async estimate(keypoints3D) {
        const predictions = await this.#gestureEstimator.estimate(
            ...
            // porcentagem de confiaça do gesto (90%)
            9,
        );
    ...
    async *detectGestures(predictions) {
        for (const hand of predictions) {
            ...
            console.log('dectected', this.#gestureStrings[result.name]);
        }
    }
    ...
    async initializeDetector() {
        ...
        const detectorConfig = {
            ...
            // full é mais pesado e o mais preciso
            modelType: 'lite',
            maxHands: 2,
        };
